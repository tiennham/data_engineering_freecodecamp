    ...
    while retries < max_retries:
        try:
            ...
            if "accepting connections" in result.stdout:
                print("xxxxxxxxxx Connect Source Docker OK xxxxxxxxxx")
                print(result.stdout)
                print(result.stderr)
                return True
            else:
                print("xxxxxxxxxx Connect Source Docker False xxxxxxxxxx")
                print(result.stdout)
                print(result.stderr)
                
        except subprocess.CalledProcessError as e:
            print("xxxxxxxxxx Error xxxxxxxxxx")
...
if not wait_for_postgres(host="source_postgres"):
    print("Connect to source docker problem!!!")
    exit(1)
...
# pg_dump -h source_postgres -U postgres -d source_db -f data_dump.sql -w+